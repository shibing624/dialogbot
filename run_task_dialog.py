...
from task_dialog import dialog_config
from task_dialog.agents import AgentCmd, InformAgent, RequestAllAgent, RandomAgent, EchoAgent, RequestBasicsAgent, \
    AgentDQN
from task_dialog.dialog_system import DialogManager, text_to_dict
from task_dialog.nlg import nlg
from task_dialog.nlu import nlu
from task_dialog.usersims import RuleSimulator
...
if __name__ == "__main__":
    ...
    parser.add_argument('--act_level', dest='act_level', type=int, default=1,
    ...
    parser.add_argument('--warm_start_epochs', dest='warm_start_epochs', type=int, default=120,
    ...
    parser.add_argument('-o', '--write_model_dir', dest='write_model_dir', type=str,
                        default='./task_dialog/checkpoints/rl_agent/',
    ...
    parser.add_argument('--diaact_nl_pairs', dest='diaact_nl_pairs', type=str,
                        default='task_dialog/data/dia_act_nl_pairs.v6.json',
                        help='path to the pre-defined dia_act&NL pairs')
    # load NLG & NLU model
    parser.add_argument('--nlg_model_path', dest='nlg_model_path', type=str,
                        default='task_dialog/models/nlg/lstm_tanh_relu_[1468202263.38]_2_0.610.p',
                        help='path to model file')
    parser.add_argument('--nlu_model_path', dest='nlu_model_path', type=str,
                        default='task_dialog/models/nlu/lstm_[1468447442.91]_39_80_0.921.p',
    ...
    parser.add_argument('--learning_phase', dest='learning_phase', default='all', type=str,
                        help='train\\test\\all; default is all')
    # parse
...
with open(movie_kb_path, 'rb') as f:
    movie_kb = pickle.load(f, encoding='iso-8859-1')
...
def run_episodes(count, status):
    ...
    for episode in range(count):
        ...
        if agt == 9 and params['trained_model_path'] == None:
            ...
            if episode % save_check_point == 0 and \
                            params['trained_model_path'] is None:  # save the model every 10 episodes
