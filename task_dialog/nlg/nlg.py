...
from task_dialog.nlg.lstm_decoder_tanh import lstm_decoder_tanh
...
class nlg:
    ...
    def diaact_to_nl_slot_filling(self, dia_act, template_sentence):
        ...
        sentence = template_sentence.decode('utf-8') if isinstance(template_sentence, bytes) else template_sentence
        counter = 0
        for slot in dia_act['inform_slots'].keys():
